...
var map = {
	"./componetname/componetname.module": [
...
const routes = [
    ...
    {
        path: 'componetname',
        loadChildren: './componetname/componetname.module#ComponetnamePageModule'
    }
];
...
module.exports = __webpack_require__(/*! D:\test\ionic-my\src\main.ts */"./src/main.ts");
